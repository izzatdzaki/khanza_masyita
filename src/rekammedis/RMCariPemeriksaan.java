    ...
    public void tampil() {
        ...
        try{
            ...
            try{
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[] {
                        false,rs.getString(1),rs.getString(2)," \nVITAL SIGN: \nSUHU:"+rs.getString(4)+" c, TENSI:"+rs.getString(5)+" mmHg, NADI:"+rs.getString(6)+" x/menit, RESPIRASI:"+rs.getString(7)+" x/menit, TINGGI:"+rs.getString(8)+" cm, BERAT:"+rs.getString(9)+" kg, SPO2:"+rs.getString(10)+", GCS:"+rs.getString(11)+", KESADARAN:"+rs.getString(12)
                    });
                }
            }catch(Exception ex){
                System.out.println(ex);
