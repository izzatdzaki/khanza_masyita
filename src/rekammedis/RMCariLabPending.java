...
public final class RMCariLabPending extends javax.swing.JDialog {
    ...
    private String[] tanggal,jam,laboratorium;
    ...
    public void tampil() {
        ...
        for(i=0;i<tabMode.getRowCount();i++){
            if(tabMode.getValueAt(i,0).toString().equals("true")){
                ...
                laboratorium[index]=tabMode.getValueAt(i,3).toString();;
                index++;
            }
        }       
        ...
        for(i=0;i<jml;i++){
            tabMode.addRow(new Object[] {
                pilih[i],tanggal[i],jam[i],laboratorium[i]
            });
        }
        Valid.tabelKosong(tabMode);
        try{
            ...
            try{
                ...
                rs=ps.executeQuery();
                while(rs.next()){
                    tabMode.addRow(new Object[] {false, rs.getString(1), rs.getString(3), rs.getString(2)}); // Corrected to display name of examination instead of time
                }
            }catch(Exception ex){
