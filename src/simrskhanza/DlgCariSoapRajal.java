 ...
 * @author dosen
 */
public class DlgCariSoapRajal extends javax.swing.JDialog {
    ...
    /** Creates new form Dlgtemplate_soap
     * @param parent
     * @param modal */
    public DlgCariSoapRajal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{"id","subjektif", "objektif", "asesemen", "planning", "Instruksi", "Evaluasi"}){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Template SOAP ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Nama.getText().trim().equals("")){
            ...
            if(tbkecamatan.getSelectedRow()!= -1){
                if(Sequel.meghapustf("template_soap_inap","id",tbkecamatan.getValueAt(tbkecamatan.getSelectedRow(),0).toString())==true){
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariSoapRajal dialog = new DlgCariSoapRajal(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
//            String iyem = "";
            ps=koneksi.prepareStatement("select * from template_soap_rajal");
            try {
//                ps.setString(1,"%"+TCari.getText().trim()+"%");
    ...
    public void isCek(){
//        BtnSimpan.setEnabled(akses.gettemplate_soap());
//        BtnHapus.setEnabled(akses.gettemplate_soap());
    }
}
