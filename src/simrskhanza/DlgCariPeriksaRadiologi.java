...
public class DlgCariPeriksaRadiologi extends javax.swing.JDialog {
    ...
    private String kdpetugas="",kdpenjab="",Suspen_Piutang_Radiologi_Ranap="",Radiologi_Ranap="",Beban_Jasa_Medik_Dokter_Radiologi_Ranap="",Utang_Jasa_Medik_Dokter_Radiologi_Ranap="",
            ...
            Beban_Jasa_Perujuk_Radiologi_Ralan="",Utang_Jasa_Perujuk_Radiologi_Ralan="",Beban_Jasa_Menejemen_Radiologi_Ralan="",Utang_Jasa_Menejemen_Radiologi_Ralan="", FileName = "",kodeberkas="";
    ...
    private void initComponents() {
        ...
        UploadHasilRad = new javax.swing.JMenuItem();
        ...
        UploadHasilRad.setBackground(new java.awt.Color(255, 255, 254));
        UploadHasilRad.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        UploadHasilRad.setForeground(new java.awt.Color(50, 50, 50));
        UploadHasilRad.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        UploadHasilRad.setText("Upload Hasil Lab ke Berkas Digital");
        UploadHasilRad.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        UploadHasilRad.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        UploadHasilRad.setName("UploadHasilRad"); // NOI18N
        UploadHasilRad.setPreferredSize(new java.awt.Dimension(300, 25));
        UploadHasilRad.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                UploadHasilRadBtnPrintActionPerformed(evt);
            }
        });
        jPopupMenu1.add(UploadHasilRad);
...
private void tbDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbDokterKeyPressed
   if(tabMode.getRowCount()!=0){
    ...
    private void UploadHasilRadBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UploadHasilRadBtnPrintActionPerformed
        FileName = "RAD_RAJAL__" + tbDokter.getValueAt(tbDokter.getSelectedRow(), 0).toString().replaceAll("/", "");
        CreatePDF(FileName);
        String filePath = "tmpPDF/" + FileName;
        UploadPDF(FileName, "berkasrawat/pages/upload/");
        HapusPDF();
    }//GEN-LAST:event_UploadHasilRadBtnPrintActionPerformed
     ...
     private void CreatePDF(String FileName) {
            ...
            finger=Sequel.cariIsi("select sha1(sidikjari.sidikjari) from sidikjari inner join pegawai on pegawai.id=sidikjari.id where pegawai.nik=?",kdpetugas);
            param.put("finger2","Dikeluarkan di "+akses.getnamars()+", Kabupaten/Kota "+akses.getkabupatenrs()+"\nDitandatangani secara elektronik oleh "+tbDokter.getValueAt(tbDokter.getSelectedRow(),2).toString()+"\nID "+(finger.equals("")?kdpetugas:finger)+"\n"+Valid.SetTgl3(tbDokter.getValueAt(tbDokter.getSelectedRow(),3).toString()));  
            Valid.MyReportPDFUpload("rptPeriksaRadiologi2.jasper","report","::[ Pemeriksaan Radiologi ]::",FileName,param);
        }
    }
    /**
    ...
    */
    ...
    private javax.swing.JMenuItem UploadHasilRad;
    ...
    private void UploadPDF(String FileName, String docpath) {
        try {
            ...
            kodeberkas = Sequel.cariIsi("SELECT kode FROM master_berkas_digital WHERE nama LIKE '%05 Penunjang Radiologi RAJAL%'");
