 ...
 * @author dosen
 */
public class DlgCariSoapinap extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCariSoapinap(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariSoapinap dialog = new DlgCariSoapinap(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
//            String iyem = "";
            ps=koneksi.prepareStatement("select * from template_soap_inap");
            try {
