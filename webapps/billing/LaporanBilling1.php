...
<body bgcolor='#ffffff'>
    ...
    if ((USERHYBRIDWEB == $usere) && (PASHYBRIDWEB == $passwordte)) {
        ...
        if (mysqli_num_rows($hasil) != 0) {
            ...
            // Tambahkan tombol untuk upload billing
...
<script>
    function uploadBilling(norawat) {
        // Buat elemen canvas untuk mengambil tampilan billing
        html2canvas(document.querySelector(".tbl_form")).then(canvas => {
            ...
            // Get nomor RM
            var no_rm = norawat.split('/')[0];

            // Generate nama file
            var filename = 'Billing_' + norawat + '_' + no_rm + '.pdf';
            ...
            formData.append('no_rawat', norawat);
            formData.append('kode', 'BLG'); // Kode untuk Billing di master_berkas_digital
